#
# Be sure to run `pod lib lint CocoaPodsHeaderDirTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CocoaPodsHeaderDirTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CocoaPodsHeaderDirTest.'
